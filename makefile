...
ui/_vendor/maplibre.css:
	wget -O $@ 'https://esm.sh/maplibre-gl@5.5.0/dist/maplibre-gl.css'
	deno fmt $@
ui/_vendor/maplibre.js:
	wget -O $@ 'https://esm.sh/v135/maplibre-gl@5.5.0/es2022/dist/maplibre-gl-dev.development.bundle.js'
